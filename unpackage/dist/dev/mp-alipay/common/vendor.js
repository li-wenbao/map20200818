...
new _vuex.default.Store({
  ...
  mutations: {
    ...
    initRouter: function initRouter(state, list) {
      ...
      state.qXtime = _utils.default.ChangeHourMinutestr(list.paths.duration); //转换成小时或者分钟
      state.qXdistance = _utils.default.Changedistance(list.paths.distance); //转换成千米或者米
